...
\title[Il percorso di una proposta in LiquidFeedback]{Il percorso di una proposta dall'idea all'approvazione in programma, nel LiquidFeedback del Partito~Pirata~Italiano}
\author{Giuseppe Cal.}
...
Se avete domande, \textsl{interrompetemi in \underline{qualsiasi} momento.}
\end{frame}
...
\begin{itemize}
\item Sostenendo una proposta le consenti di andare ai voti.
...
; uno sfondo arancione chi ha eseguito il tuo voto

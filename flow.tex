\documentclass[ignorenonframetext,11pt]{beamer}\usetheme{default}\usecolortheme{crane}
...
In alternativa alla partecipazione diretta, è possibile \textbf{impostare un fiduciario} che agirà in proprio nome all'interno di quell'area; o \textit{ignorarla del tutto, fidandosi di ciò che gli altri decidono}.

\begin{description}\item[Quorum:] anche delegando si concorre al calcolo della popolazione di un'area, e quindi dei quorum.\end{description}
